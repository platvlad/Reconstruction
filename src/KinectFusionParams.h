...
struct KinectFusionParams
{
    ...
    KinectFusionParams() :
        ...
        m_cMinSuccessfulTrackingFramesForCameraPoseFinder(1), // only update the camera pose finder initially after 45 successful frames (1.5s)
